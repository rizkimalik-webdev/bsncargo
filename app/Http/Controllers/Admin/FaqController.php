...
class FaqController extends Controller
{
    ...
    public function store_syarat(Request $request)
    {
        ...
        return redirect('/admin/faq/syarat')->with('status', 'Berhasil tambah Data.');
    }
    ...
    public function update_syarat(Request $request, Faq $faqs)
    {
        ...
        if($faq){
            ...
            return redirect('/admin/faq/syarat')->with('status','Data Berhasil Diupdate!');
        }else{
            //! redirect dengan pesan error
            return redirect('/admin/faq/syarat')->with('status','Data Gagal Diupdate!');
        }
    }
    ...
    public function store_bisnis(Request $request)
    {
        ...
        return redirect('/admin/faq/bisnis')->with('status', 'Berhasil tambah Data.');
    }
    ...
    public function update_bisnis(Request $request, Faq $faqs)
    {
        ...
        if($faq){
            //? redirect dengan pesan sukses
            return redirect('/admin/faq/bisnis')->with('status','Data Berhasil Diupdate!');
        }else{
            //! redirect dengan pesan error
            return redirect('/admin/faq/bisnis')->with('status','Data Gagal Diupdate!');
        }
    }
