...
class PartnerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/partner')->with('status', 'Berhasil tambah Data.');
    }
    ...
    public function update(Request $request, Partner $partners)
    {
        ...
        if($partner){
            ...
            return redirect('/admin/partner')->with('status','Data Berhasil Diupdate!');
        }else{
            //! redirect dengan pesan error
            return redirect('/admin/partner')->with('status','Data Gagal Diupdate!');
        }
    }
