...
class ClientController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/client')->with('status', 'Berhasil tambah Data.');
    }
    ...
    public function update(Request $request, Client $clients)
    {
        ...
        if($client){
            ...
            return redirect('/admin/client')->with('status','Data Berhasil Diupdate!');
        }else{
            //! redirect dengan pesan error
            return redirect('/admin/client')->with('status','Data Gagal Diupdate!');
        }
    }
