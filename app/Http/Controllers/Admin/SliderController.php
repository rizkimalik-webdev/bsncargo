...
class SliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/slider')->with('status', 'Berhasil tambah Data.');
    }
    ...
    public function update(Request $request, Slider $sliders)
    {
        ...
        if($slider){
            ...
            return redirect('/admin/slider')->with('status','Data Berhasil Diupdate!');
        }else{
            //! redirect dengan pesan error
            return redirect('/admin/slider')->with('status','Data Gagal Diupdate!');
        }
    }
