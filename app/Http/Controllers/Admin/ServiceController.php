...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/service')->with('status', 'Berhasil tambah Data.');
    }
    ...
    public function update(Request $request, Service $services)
    {
        ...
        if($service){
            ...
            return redirect('/admin/service')->with('status','Data Berhasil Diupdate!');
        }else{
            //! redirect dengan pesan error
            return redirect('/admin/service')->with('status','Data Gagal Diupdate!');
        }
    }
