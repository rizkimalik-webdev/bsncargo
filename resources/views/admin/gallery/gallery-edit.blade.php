<x-admin-layout>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('/admin/gallery/update', $galleries->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="pull-right">
                    ...
                    <a href="{{ url('/admin/gallery') }}" class="btn btn-outline-primary">Kembali</a>
                </div>
            </form>
        </div>
    </div>
