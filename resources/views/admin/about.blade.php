<x-admin-layout>
    <div class="container">
        <div class="py-5 text-center">
            <img class="d-block mx-auto mb-4" src="{{ asset('public/theme/images/'.$company->image) }}" alt=""
                width="80" height="80">
        ...
        <form action="{{ url('/admin/about/update', $about->company_id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
