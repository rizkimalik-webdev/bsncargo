    ...
    <div class="container-fluid">
        ...
        <div class="row mb-5">
            <div class="col-lg-12 d-flex justify-content-end">
                <a href="{{ url('/admin/service/create') }}" class="btn btn-sm btn-primary">Tambah Data</a>
            </div>
        </div>
    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-center mt-5">
                                    <a href="{{ url('/admin/service/'.$item->id.'/edit') }}" class="btn btn-sm btn-primary m-1">Edit</a>
                                    <a href="{{ url('/admin/service/destroy/'.$item->id) }}" class="btn btn-sm btn-danger m-1">Hapus</a>
                                </div>
