<x-admin-layout>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mt-4">
            <li class="breadcrumb-item"><a href="{{ url('/faq/bisnis') }}">Faq</a></li>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('/faq/bisnis/update', $faqs->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="pull-right">
                    ...
                    <a href="{{ url('/faq/bisnis') }}" class="btn btn-outline-primary">Kembali</a>
                </div>
            </form>
        </div>
    </div>
