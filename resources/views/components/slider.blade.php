<div class="hero-slider">
    <!-- Slider Item -->
    <div class="slider-item slide1" style="background-image:url({{ asset('theme/images/slider/slider-1.png') }})">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Slide Content Start -->
                    <div class="content style text-center">
                        <h2 class="text-white text-bold mb-2" data-animation-in="slideInLeft">Tarif Kompetitif</h2>
    ...
    <!-- Slider Item -->
    <div class="slider-item" style="background-image:url({{ asset('theme/images/slider/slider-2.png') }});">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Slide Content Start-->
                    <div class="content style text-center">
                        <h2 class="text-white" data-animation-in="slideInRight">Pengiriman Cepat</h2>
    ...
    <!-- Slider Item -->
    <div class="slider-item" style="background-image:url({{ asset('theme/images/slider/slider-3.png') }})">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Slide Content Start -->
                    <div class="content text-center style">
                        <h2 class="text-white text-bold mb-2" data-animation-in="slideInRight">Layanan</h2>
